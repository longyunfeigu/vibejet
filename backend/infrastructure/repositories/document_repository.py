...
class SQLAlchemyDocumentRepository(SoftDeleteFilterMixin, DocumentRepository):
    ...
    async def update(self, document: Document) -> Document:
        ...
        model.file_asset_id = document.file_asset_id
        model.title = document.title
        model.source_filename = document.source_filename
        model.content_type = document.content_type
        model.parser = document.parser
        model.status = document.status
        model.content_md = document.content_md
        model.error_code = document.error_code
        model.error_message = document.error_message
        model.extra_metadata = document.metadata or {}
