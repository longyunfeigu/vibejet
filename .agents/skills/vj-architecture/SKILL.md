...
```
┌─────────────────┐
│ vj-product-     │  输入：PRD 文档
│ requirements    │────────────────────┐
└─────────────────┘                    │
                                       ▼
                              ┌─────────────────┐
                              │ vj-architecture │  本 Skill
                              │                 │
                              └────────┬────────┘
                                       │
                              ┌────────┴────────┐
                    ...
                    ▼                  ▼                  ▼                  ▼
           ┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌──────────────┐
           │ api-design  │    │ data-model  │    │vj-epic-story│    │task-breakdown│
           │  API 接口   │    │  数据模型   │    │ Epic+Story  │    │   任务拆分   │
           │   ✅ 已实现  │    │   ✅ 已实现  │    │   ✅ 已实现  │    │   ⏳ 待开发  │
           └─────────────┘    └─────────────┘    └─────────────┘    └──────────────┘
```
...
- **输出去向**：
  ...
  - `vj-epic-story` ✅：提供业务模块划分、技术选型、分层约束等信息
