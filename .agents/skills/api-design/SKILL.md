...
3. 已存在的 API 设计文档：`docs/project/api_spec.md` 或 Epic `source_documents.api_design`
4. 当前代码中的 route / DTO / test / 前端调用

如果现有 `docs/project/api_spec.md` 不存在，不要默认要求创建完整文档。
...
写回规则：
- 如果 `docs/project/api_spec.md` 已存在：优先做增量更新，不重写整份文档
...
- 本次 API delta 是什么
- 影响哪些实现和测试
- 是否需要写回 `docs/project/api_spec.md`
