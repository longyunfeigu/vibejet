...
- docs/project/api/conventions.md + docs/project/api/{module}.md → API 规范（如存在；旧 api_spec.md 仅 fallback）
- docs/project/data/overview.md + docs/project/data/{module}.md → 数据模型（如存在；旧 database_schema.md 仅 fallback）
